...
export function GameCard({ title, description, role, image, tags, year }: GameCardProps) {
  return (
    <Card className="group overflow-hidden bg-slate-900/50 border-slate-800 hover:border-purple-500/50 transition-all duration-300">
      <div className="relative overflow-hidden aspect-video">
        ...
        <div className="absolute top-4 right-4">
          <Badge variant="secondary" className="bg-purple-900/80 text-purple-100 border-purple-500/30">
            {year}
          </Badge>
        </div>
